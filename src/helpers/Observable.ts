// typescript fork of https://github.com/zenparsing/es-observable

// === Symbol Polyfills ===
declare var Symbol: any;
const __symbolename = 'observable';
...
export class Observable<T> {
    ...
    _subscriber: (observer: { next: () => void }) => void;
    ...
    subscribe(observer: { next: (item: T) => void, error: (e: any) => void, complete: () => void } | Function, ...args) {
    ...
    static from(x) {
        ...
        let method = getMethod(x, Symbol[__symbolename]);
